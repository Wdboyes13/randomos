...
static unsigned int const_func ilog2_32(uint32_t v);
static unsigned int const_func ilog2_64(uint64_t v);
static int const_func alignlog2_32(uint32_t v);
static int const_func alignlog2_64(uint64_t v);
#endif
...
extern_inline static unsigned int const_func ilog2_32(uint32_t v)
{
    return stdc_leading_zeros(defang_zero(v)) ^ 31;
}

extern_inline static unsigned int const_func ilog2_64(uint64_t v)
{
...
extern_inline static unsigned int const_func ilog2_64(uint64_t vv)
{
    unsigned int p = 0;
    uint32_t v;
 ...
 */
extern_inline static int const_func alignlog2_32(uint32_t v)
{
    if (unlikely(v & (v-1)))
...
extern_inline static int const_func alignlog2_64(uint64_t v)
{
    if (unlikely(v & (v-1)))
        return -1;              /* invalid alignment */
